...
public class Calculator extends javax.swing.JFrame {
    ...
    public Calculator() {
       ...
       jRadioButton1.setEnabled(false); //on button disable when on
    ...
    //create a method for OFF
    //setEnabled to false - all buttons to false
    public void disable()
    {
        jTextField1.setEnabled(false);
        
        jRadioButton1.setEnabled(true);  //ON button Enable
        jRadioButton2.setEnabled(false);  //OFF button Dis-Enable
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        /*
        jTextField is an object of Text Field. which is auto created in IDE
        setText() method displays text/numbers in the TextField
        TextField accepts a string only
        */
        ...
        /*
        jTextField1.setText()
        getText is a method used to retrieve the current text form the Text Field
        */
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        //remove this line to display + sign on label instead of TextField
        ...
        calculation = 1;
        jTextField1.setText("");
        //display current numbers and + sign on label
        jLabel1.setText(num + "+");
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
         ...
         //jTextField1.setText(jTextField1.getText() + "=");
        //call arithmetic op method()
         arithmetic_operation();
         //after performing operation label will be clear
         jLabel1.setText("");
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        ...
        disable(); // call this disable method when button is called
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //lenght() method that returns a string
        //eg: Truck returns 5
        //-1 subtracts 1 from the lenght
        int length = jTextField1.getText().length();
        int number = jTextField1.getText().length() -1;
        
        //declare Store variable - datatype String
        String store;
        
        if(length > 0)
        {
            //StringBuilder creates empty StringBuilder used to store Strings
            //back is object of StringBuilder
            //the value of TextField is stored in StringBuilder 'back'
            StringBuilder back = new StringBuilder(jTextField1.getText());
           
            //method used to delete a single char from specific position
            back.deleteCharAt(number);
            
            //convert StringBuilder back into String
            //because TextField only takes String Values
            store=back.toString();
            
            //'store' variable set in setText() mehtod
